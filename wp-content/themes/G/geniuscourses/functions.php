...
// 	// wp_engueue_style('geniuscourses-general', get_template_directory_uri().'/assets/css/general.css', array(), '2023', 'all');

// 	wp_engueue_script('geniuscourses-script', get_template_directory_uri().'/assets/js/script.js', array(), '2023', true);
// }
// add_action('wp_engueue_scripts', 'geniuscourses_engueue_scripts');
...
function geniuscourses_enqueue_scripts(){
	...
	wp_engueue_script("geniuscourses-script", get_template_directory_uri()."/assets/js/script.js", array(), "1.0", true);
}
add_action("wp_engueue_scripts", "geniuscourses_engueue_scripts");
